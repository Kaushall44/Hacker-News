...
const Header: React.FC<HeaderProps> = ({ searchQuery, setSearchQuery }) => {
  return (
    <header className="relative border-b border-white/20 bg-white/70 backdrop-blur-xl sticky top-0 z-50 transition-all duration-300">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-6">
        <div className="flex items-center justify-between gap-8">
          <div className="flex items-center animate-fade-in">
            <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-700 bg-clip-text text-transparent tracking-tight hover:scale-105 transition-transform duration-200">
              HackerNews
            </h1>
          </div>
